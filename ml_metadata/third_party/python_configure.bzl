"""Repository rule for configuring a local Python repo.Add commentMore actions
...
def _create_local_python_repository(repository_ctx):
    ...
    build_tpl = repository_ctx.path(Label("//ml_metadata/third_party:local_python.BUILD.tpl"))

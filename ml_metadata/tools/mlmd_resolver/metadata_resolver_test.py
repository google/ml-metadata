...
def create_artifact_type(
    store: metadata_store.MetadataStore, typename: str
...
def create_artifact(
    store: metadata_store.MetadataStore, artifact_type_id: int, name: str
...
def create_context(
    store: metadata_store.MetadataStore, context_type_id: int, context_name: str
